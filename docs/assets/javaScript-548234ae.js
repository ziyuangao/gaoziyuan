import{_ as m,r as d,i as p,b as n,o as l,c as o,d as _,w as s,F as u,e as v,f as h,a as f}from"./index-28431914.js";const b={setup(){const r=d([{id:1,title:"关于ES6中 var/let/const 的个人理解",name:"a1",html:`先说区别 </br>
        ...
        以上改动点属于纯前端操作，接口还是原本的响应速度，但是从用户体验上来讲，用户觉得页面“响应”要比之前快多了，而且没有全局的loading阻塞用户行为，体验感提升了不少。`},{id:7,title:"JS的计时器是否准确？为什么？",name:"a7",html:`分为四个层面。1硬件。不存在绝对意义的精确计时，相对意义精确的计时是原子钟，计算机硬件并非原子钟，所以硬件方面计时并不准确。2软件。浏览器中js代码
        ...
        间隔是4ms(毫秒)。4事件循环。计时器到达后也不一定会马上执行，而是要等待执行栈清空后才会执行。`}]);let t=p("");return{list:r,activeName:t}}},y=["innerHTML"];function k(r,t,g,a,x,N){const i=n("el-collapse-item"),c=n("el-collapse");return l(),o("div",null,[_(c,{modelValue:a.activeName,"onUpdate:modelValue":t[0]||(t[0]=e=>a.activeName=e),accordion:"",class:"collapse-content"},{default:s(()=>[(l(!0),o(u,null,v(a.list,e=>(l(),h(i,{key:e.id,title:e.title,name:e.name},{default:s(()=>[f("div",{innerHTML:e.html},null,8,y)]),_:2},1032,["title","name"]))),128))]),_:1},8,["modelValue"])])}const j=m(b,[["render",k],["__scopeId","data-v-25c9558f"]]);export{j as default};
