import{_ as d,r as m,i as p,b as r,o as l,c as s,d as _,w as n,F as u,e as v,f,a as b}from"./index-63b5e911.js";const h={setup(){const o=m([{id:1,title:"关于ES6中 var/let/const 的个人理解",html:`先说区别 </br>
        ...
        初始化设置值的位置，&&确实可以用来确认对象是否存在这个属性，但是放在if判断就存在歧义了。还是源于日常开发时自己对细节没有严格要求导致的。`}]);let t=p("");return{list:o,activeName:t}}},y=["innerHTML"];function k(o,t,g,a,j,x){const i=r("el-collapse-item"),c=r("el-collapse");return l(),s("div",null,[_(c,{modelValue:a.activeName,"onUpdate:modelValue":t[0]||(t[0]=e=>a.activeName=e),accordion:"",class:"collapse-content"},{default:n(()=>[(l(!0),s(u,null,v(a.list,e=>(l(),f(i,{key:e.id,title:e.title,name:`item-${e.id}`},{default:n(()=>[b("div",{innerHTML:e.html},null,8,y)]),_:2},1032,["title","name"]))),128))]),_:1},8,["modelValue"])])}const V=d(h,[["render",k],["__scopeId","data-v-5eff7988"]]);export{V as default};
