import{_ as m,r as d,i as p,b as n,o as r,c as o,d as _,w as s,F as u,e as v,f as h,a as f}from"./index-8001ece9.js";const b={setup(){const l=d([{id:1,title:"关于ES6中 var/let/const 的个人理解",name:"a1",html:`先说区别 </br>
        ...
        逻辑严谨程度打折扣（数据以前端为准），用户体验打折扣（app体量增大），源数据来源于数据库，处理在前端，项目的使用分配头重脚轻，核心业务由前端的处理数据不安全，不准确。`}]);let t=p("");return{list:l,activeName:t}}},y=["innerHTML"];function k(l,t,x,a,g,N){const c=n("el-collapse-item"),i=n("el-collapse");return r(),o("div",null,[_(i,{modelValue:a.activeName,"onUpdate:modelValue":t[0]||(t[0]=e=>a.activeName=e),accordion:"",class:"collapse-content"},{default:s(()=>[(r(!0),o(u,null,v(a.list,e=>(r(),h(c,{key:e.id,title:e.title,name:e.name},{default:s(()=>[f("div",{innerHTML:e.html},null,8,y)]),_:2},1032,["title","name"]))),128))]),_:1},8,["modelValue"])])}const B=m(b,[["render",k],["__scopeId","data-v-49485068"]]);export{B as default};
